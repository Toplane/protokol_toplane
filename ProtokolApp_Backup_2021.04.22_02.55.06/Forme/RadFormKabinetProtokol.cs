...
{
    public partial class RadFormKabinetProtokol : Telerik.WinControls.UI.RadForm
    {
        ...
        private  void FrmOsnovni_Load(object sender, EventArgs e)
        {
            ...
            List<sluzbe> sluzbeList = new List<sluzbe>();
            using (var context = new protokolEntities1(Helper.ProcitajEntityConnectionString()))
            {
                sluzbeList = context.sluzbe.Where(i => i.ID == 8).ToList();
            }
        ...
        public async Task<BindingList<protokolKabinetDTO>> Citaj(int id_sluzbe)
        {
            try
            {
                ...
                return protokolKabinetDTO.GetAll(mainProtokolEntities);
            }
            catch(Exception ex)
            {
                return null;
        ...
        private async void frmOsnovna_EnabledChanged(object sender, EventArgs e)
        {
            ...
            {
                radGridView2.Rows.Clear();
                radGridView1.DataSource = protokolKabinetDtos= await Task.Run(() => Citaj(_idSluzbe));
            }
        }
        ...
        private void radButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                protokolKabinetDTO.SaveAll(mainProtokolEntities, protokolKabinetDtos);
                //RadMessageBox.ThemeName = "Office2010Silver";
 ...
 #region exportExcel
        ...
        private BindingList<protokolKabinetDTO> protokolKabinetDtos;
        private  void radButton5_Click(object sender, EventArgs e)
        {
            radGridView1.DataSource = protokolKabinetDtos = protokolKabinetDTO.GetAll(mainProtokolEntities);
        }
