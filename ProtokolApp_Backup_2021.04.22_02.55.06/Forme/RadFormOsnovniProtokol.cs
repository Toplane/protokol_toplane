...
namespace ProtokolApp
{
    public partial class RadFormOsnovniProtokol : Telerik.WinControls.UI.RadForm
    {
        ...
        private async void radDropDownList1_SelectedIndexChanged(object sender, Telerik.WinControls.UI.Data.PositionChangedEventArgs e)
        {
            ...
            try
            {
                if ((int)radDropDownList1.SelectedItem.Value == 9)
                {
                   ...
                   // radGridView1.Columns["predmet"].HeaderText = "Broj računa";
                   //radGridView1.Columns["dostava_dopisa"].HeaderText = "Iznos";
                   // radGridView1.Columns["razvod"].HeaderText = "Pošiljalac";
                   // radGridView1.Columns["veza"].HeaderText = "Kome je signiran";
                }
                ...
                if ((int)radDropDownList1.SelectedItem.Value == 1)
                {
                    ...
                    //radGridView1.Columns["predmet"].HeaderText = "Predmet";
                    //radGridView1.Columns["dostava_dopisa"].HeaderText = "Dostava dopisa";
                    //radGridView1.Columns["razvod"].HeaderText = "Razvod";
                    //radGridView1.Columns["veza"].HeaderText = "Veza";
                }
            }
            catch (Exception ex)
            {
